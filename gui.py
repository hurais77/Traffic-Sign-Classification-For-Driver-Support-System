...
label=Label(top,background='#F3F3F3', font=('arial',25,'bold'))
...
upload.configure(font=('arial',15,'bold'))

upload.pack(side=BOTTOM,pady=50)
sign_image.pack(side=BOTTOM,expand=True)
label.pack(side=BOTTOM,expand=True)
heading = Label(top, text="Classify The Signs",pady=20, font=('arial',25,'bold'))
