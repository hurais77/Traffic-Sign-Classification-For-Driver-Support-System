...
dataGen.fit(X_train)
batches= dataGen.flow(X_train,y_train,batch_size=32)  # REQUESTING DATA GENRATOR TO GENERATE IMAGES  BATCH SIZE = NO. OF IMAGES CREAED EACH TIME ITS CALLED
